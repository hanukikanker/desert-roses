...
Temperature is now trending at an unprecedented rate
...
Projected number of hot days are exceeding records. From 2020 40 degree days will be the norm.
```{r, echo=FALSE, out.width='75%',fig.align='centre'}
...
50% loss in water bodies in less than 3 decades. 
.pull-left[
```{r, echo=FALSE, out.width='140%', fig.align='centre'}
knitr::include_graphics('Images/RS - images/Screenshot 2024-03-05 at 13.25.58.jpeg')
```
]
.pull-right[
```{r, echo=FALSE, out.width='120%', fig.align='centre' }
...
A loss of natural flora in the region
...
eo_data_df <- read_excel("images/eoData.xlsx")

# Replace NA with empty strings for better table formatting
#eo_data_df[is.na(eo_data_df)] <- ""

# Ccreate a table with merged cells
#kable_out <- kable(eo_data_df, "html", escape = FALSE) %>%
#  kable_styling(bootstrap_options = c("striped", "hover", #"condensed", "responsive")) %>%
#  column_spec(1, width = "150px") %>%
#  row_spec(1, extra_css = "height: 120px;") %>%
